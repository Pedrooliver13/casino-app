  ...
  (
    ...
    return (
      <div
        ...
        className={`${classDiv || ''} flex translate-y-4 animate-[fadeIn_0.5s_ease-out_forwards] flex-col gap-1 opacity-0 data-[remove-height=false]:h-[80px]`}
      >
        <Label
          htmlFor={props?.id}
          className={`text-base ${error ? 'text-error' : ''}`}
        >
